...
[_MTH] = LAYOUT_preonic_grid( \
  ...
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_LABK, KC_RABK, KC_P7,   KC_P8,   KC_P9,   KC_PDOT, \
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PPLS, KC_PMNS, KC_P4,   KC_P5,   KC_P6,   KC_P0, \
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PAST, KC_PSLS, KC_P1,   KC_P2,   KC_P3,   KC_PEQL, \
  _______, KC_LSFT, KC_LALT, KC_LCTL, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PENT, XXXXXXX, XXXXXXX, XXXXXXX \
),
